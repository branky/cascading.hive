...
INSERT INTO PARTITIONS (PART_ID, CREATE_TIME, LAST_ACCESS_TIME, PART_NAME, SD_ID, TBL_ID) values (1, 1398587674, 0, 'p=1', 41, 41);
INSERT INTO PARTITIONS (PART_ID, CREATE_TIME, LAST_ACCESS_TIME, PART_NAME, SD_ID, TBL_ID) values (2, 1398587924, 0, 'p=2', 42, 41);
INSERT INTO PARTITIONS (PART_ID, CREATE_TIME, LAST_ACCESS_TIME, PART_NAME, SD_ID, TBL_ID) values (3, 1111111, 1111111, '1', 43, 42);
...
INSERT INTO PARTITION_KEY_VALS (PART_ID, PART_KEY_VAL, INTEGER_IDX) VALUES (1, '1', 0);
INSERT INTO PARTITION_KEY_VALS (PART_ID, PART_KEY_VAL, INTEGER_IDX) VALUES (2, '2', 0);
...
INSERT INTO PARTITION_PARAMS (PART_ID, PARAM_KEY, PARAM_VALUE) VALUES (1, 'transient_lastDdlTime', '1398587674');
INSERT INTO PARTITION_PARAMS (PART_ID, PARAM_KEY, PARAM_VALUE) VALUES (2, 'transient_lastDdlTime', '1398587924');
...
INSERT INTO SDS (SD_ID, CD_ID, INPUT_FORMAT, IS_COMPRESSED, IS_STOREDASSUBDIRECTORIES, LOCATION, NUM_BUCKETS, OUTPUT_FORMAT, SERDE_ID) VALUES (41,41,'org.apache.hadoop.mapred.TextInputFormat','N','Y','src/test/resources/data/test.partition/p=1',-1,'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat',41);
INSERT INTO SDS (SD_ID, CD_ID, INPUT_FORMAT, IS_COMPRESSED, IS_STOREDASSUBDIRECTORIES, LOCATION, NUM_BUCKETS, OUTPUT_FORMAT, SERDE_ID) VALUES (42,41,'org.apache.hadoop.mapred.TextInputFormat','N','Y','src/test/resources/data/test.partition/p=2',-1,'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat',42);
INSERT INTO SDS (SD_ID, CD_ID, INPUT_FORMAT, IS_COMPRESSED, IS_STOREDASSUBDIRECTORIES, LOCATION, NUM_BUCKETS, OUTPUT_FORMAT, SERDE_ID) VALUES (43,42,'org.apache.hadoop.mapred.TextInputFormat','N','Y','src/test/resources/data/test.partition.rc/p=1',-1,'parquet.hive.DeprecatedParquetOutputFormat',43);
...
INSERT INTO SERDES (SERDE_ID, NAME, SLIB) VALUES (43,NULL,'org.apache.hadoop.hive.serde2.lazy.LazySimpleSerDe');
...
INSERT INTO SERDE_PARAMS (SERDE_ID, PARAM_KEY, PARAM_VALUE) VALUES (41,'serialization.format','1');
INSERT INTO SERDE_PARAMS (SERDE_ID, PARAM_KEY, PARAM_VALUE) VALUES (41,'field.delim','	');
INSERT INTO SERDE_PARAMS (SERDE_ID, PARAM_KEY, PARAM_VALUE) VALUES (42,'serialization.format','1');
INSERT INTO SERDE_PARAMS (SERDE_ID, PARAM_KEY, PARAM_VALUE) VALUES (42,'field.delim','	');
INSERT INTO SERDE_PARAMS (SERDE_ID, PARAM_KEY, PARAM_VALUE) VALUES (43,'field.delim','	');
INSERT INTO SERDE_PARAMS (SERDE_ID, PARAM_KEY, PARAM_VALUE) VALUES (43,'serialization.format','	');
