...
public class HCatTapTest {
    ...
    public void testPartitionsIn() throws IOException {
        ...
        FileAssert.assertEquals(new File("src/test/resources/data/test_partition_0.txt"),
                new File(resultPath + "testPartitionsIn/part-00000"));
        FileAssert.assertEquals(new File("src/test/resources/data/test_partition_1.txt"),
                new File(resultPath + "testPartitionsIn/part-00001"));
    }
